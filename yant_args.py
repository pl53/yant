...
def parse(args):
    yant_desc = "YANT is a commanline notebook tool.\n" + \
                "Each notebook is a collection of unordered note entries.\n" + \
                "Each entry has a unique title and unlimited notes.\n" + \
                "Each notebook can be attached with unlimited tags.\n" + \
                "User can add/remove notes and tags.\n" + \
                "User can also search and randomly review notes by book or tag."
    ...
    parser_add.add_argument("note", metavar="note_title", help="title of the new note")
    ...
    parser_rm.add_argument("note", metavar="note_title", help="title of the note")

    parser_up = subparsers.add_parser("update", aliases=["up"], \
                                      help="Update a note")
    parser_up.add_argument("note", metavar="note_title", help="title of the note to be updated")
    ...
    parser_find = subparsers.add_parser("find", aliases=["search"], help="Find notes with the keyword")
    ...
    parser_find.add_argument("--exec", help="command executed on each node, use {} for note title")
    ...
    parser_review.add_argument("--exec", \
                               help="command executed on each note, use {} for note title")
    ...
    parser_import = subparsers.add_parser("import", help="Import notes from a file")
    ...
    parser_export = subparsers.add_parser("export", help="Export notes to a file")
